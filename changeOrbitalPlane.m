...
% omi                   [1x1]   final pericenter anomaly
...
ui = atan2(sin(abs(DeltaOM))/sin(alfa)*sin(i_f), (-cos(i_f) + cos(alfa)*cos(i_i))/sin(alfa)/sin(i_i));
uf = atan2(sin(abs(DeltaOM))/sin(alfa)*sin(i_i), (cos(i_i) - cos(alfa)*cos(i_f))/sin(alfa)/sin(i_f));
